...
- [Learning DSPy (2): Internals](https://thedataquarry.com/blog/learning-dspy-2-understanding-the-internals/)
- [DeepLearningAI course - DSPy: Build and Optimize Agentic Apps](https://www.deeplearning.ai/short-courses/dspy-build-optimize-agentic-apps/)
- [Automated Prompt Optimization in DSPy: Mechanisms, Algorithms, and Observability](https://msazure.club/automated-prompt-optimization-in-dspy-mechanisms-algorithms-and-observability/)
- [DSPy AI Program Examples](https://github.com/Scale3-Labs/dspy-examples/tree/main)
- [Optimizing Prompts for Language Model Pipelines: DSPy MIPROv2](https://agentissue.medium.com/optimizing-prompts-for-language-model-pipelines-dspy-miprov2-574e3fa8aa93)
...
- [3 Challenges in Machine based reasoning](https://www.amazon.science/blog/three-challenges-in-machine-based-reasoning)
- [Zep: agent memmory, context ... with KGs](https://www.getzep.com/)
- [Building MCP server with FastMCP](https://www.datacamp.com/tutorial/building-mcp-server-client-fastmcp?dc_referrer=https%3A%2F%2Fwww.google.com%2F)
...
- [Fundational models in computational pathology](https://medium.com/@loomy.sjyoo/the-state-of-foundation-models-in-computational-pathology-a-comprehensive-survey-ac4fd2a62ff0)
- [Mastering Intelligent Agents Langgraph workshop 2025](https://github.com/dipanjanS/mastering-intelligent-agents-langgraph-workshop-dhs2025)
- [Building a generic extraction AI agent](https://medium.com/data-science-collective/building-a-generic-knowledge-extraction-ai-agent-that-allows-the-creation-of-flexible-586d6a1b1499)
- [CrewAI vision tool](https://github.com/paquino11/vision_tool_crewai)
- [Exploring Memento: Fine-tuning LLM Agents without Fine-tuning LLMs](https://medium.com/the-ai-forum/exploring-memento-fine-tuning-llm-agents-without-fine-tuning-llms-4a76bf918cdd)
